            ...
            <form class="" action="saveLecture.php" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  foreach ($selectedid as $optionName) {
                ...
                <div class="form-group">
                  ...
                  foreach ($selectedFacilitator as $optionName) {
                    $ab = "<option value =" . $row['facilitator_id'] . ">" . $optionName . "</option>";
                    echo $ab;
                    die();
                  }
                ...
                <input type="text" class="form-control" name="lecture_id" placeholder="Enter Lectures name" value="">
              </div>
