            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/napd_olms/admin/login/?verification='.$code.'">http://localhost/napd_olms/admin/login/?verification='.$code.'</a></b>';
