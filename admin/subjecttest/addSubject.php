          ...
          <div class="card-body">
            <form class="" action="saveSubject.php" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <?php
                $i = 1;
                $sql = "SELECT * FROM tblsubject a JOIN tblcourse b ON a.course_id = b.course_id JOIN tblfacilitator c ON a.facilitator_id = c.facilitator_id;";
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="course_name" placeholder="Enter course name" value="<?php $row2['course_name'] ?>">
                </div>
